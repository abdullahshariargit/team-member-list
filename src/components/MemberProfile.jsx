...
const MemberProfile = ({name,role,image}) => {
  return (
    <div className='bg-white shadow-md rounded-lg p-4 border border-gray-200
        hover:-translate-y-2 transition-all duration-300 ease-in-out hover:ring-2 ring-green-400 cursor-pointer'>
             <img className='w-32 h-32 rounded-full mx-auto mb-4 object-cover'
